                        ...
                        "201": {
                            ...
                            headers: {
                                "Set-Cookie": {
                                    ...
                                    type: "string",
                                    example: "accessToken=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...; HttpOnly; Path=/; Max-Age=3600; SameSite=strict; Secure",
                                },
                            },
                            content: {
                                "application/json": {
                            ...
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        identifier: {
                                            type: "string",
                                            description: "The user's email or phone number. Use email format for email or a numeric string for phone.",
                                        },
                                        password: {
                                            type: "string",
                                            format: "password",
                            ...
                            "application/json": {
                                schema: {
                                    ...
                                    properties: {
                                        entity: {
                                            type: "string",
                                            description: "The resource or entity for which permission is being checked (e.g., 'user', 'member')",
                                        },
                                        action: {
                                            type: "string",
                                            description: "The type of action requested on the entity (e.g., 'view', 'update', 'create', 'delete').",
                                        },
                                    },
